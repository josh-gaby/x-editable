...
require(["loader", jqurl], function (loader) {
    ...
    var config = loader.getConfig("../src"), params = loader.getParams();
    ...
    require(['test/unit/api'], function () {
        //disable effects
        $.fx.off = true;
    ...
    function addTests(config) {
        ...
        switch (params.f) {
            case 'bootstrap2':
                custom = ['test/unit/datefield', 'test/unit/date', 'test/unit/datetimefield', 'test/unit/datetime', 'test/unit/wysihtml5', 'test/unit/typeahead'];
                break;

            case 'bootstrap3':
                custom = ['test/unit/datefield', 'test/unit/date', 'test/unit/datetimefield', 'test/unit/datetime', 'test/unit/typeaheadjs'];
                break;
        ...
        var tests = ['test/mocks', 'test/unit/common', 'test/unit/text', 'test/unit/textarea', 'test/unit/select', 'test/unit/checklist', 'test/unit/combodate', 'test/unit/select2'];
